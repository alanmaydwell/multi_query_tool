...
class QueryPanel:
    ...
    def __init__(self,frame,title="SQL Query Definitions",defaultfile='default.dat'):
        ...
        self.lfilename=ttk.Label(fileframe,text=os.path.basename(self.setfile),style="BG.TLabel")
        ...
        #Reload SQL button
        self.bsqlreload = ttk.Button(self.qframe,text="Reload SQL",command=self.reload_all_sql)
    ...
    def add_query(self):
        ...
        for h in (self.headings):
            ...
            #SQL
                ...
                col=col+1
                details[h]=ttk.Entry(self.qframe,width=68, style="BG.TEntry")
...
class TestRunGui:
    ...
    def __init__(self,win_title="Query Thingy"):
        ...
        #Align Button
        al_button = ttk.Button(runframe,text="Align Columns", command=self.align)
        al_button.grid(row=1,column=6,padx=(4,40))

        #Display results in separate window tickbox
        #"Safety catch" tickbox for quickload and quicksave
        self.extwinlabel=ttk.Label(runframe,text="Display results in external window")
        self.extwinlabel.grid(row=1,column=7)
        self.extwinvar=Tkinter.IntVar()
        self.extwinvar.set(0)
        self.extwinbox=ttk.Checkbutton(runframe, variable = self.extwinvar)
        ...
        self.resframe=ttk.Frame(self.rcanvas,borderwidth=0, relief="groove")
    ...
    def go(self):
        ...
        if self.extwinvar.get() == 1:
            ...
            #Create new results window
                ...
                self.ext_resframe = ttk.Frame(self.results_canvas)
        ...
        for i,q in enumerate(self.queries):
            self.results_frames.append(ttk.Frame(self.destination_frame,relief="groove",borderwidth=6))#create a frame for each query
